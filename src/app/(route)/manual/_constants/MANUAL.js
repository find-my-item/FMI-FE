export const MANUAL = [
  ...
  },
  {
    ...
    content: (
      <>
        신용카드는 분실 시에는 해당 카드사에 분실신고를 해야해요. 여러장의 신용카드를 분실 했을
        경우, 신용카드 분실 일괄신고 서비스를 이용해 분실할 신용카드사 중 한 곳의 고객센터에
  ...
  },
  {
    ...
    content: (
      <>
        ...
        발신정지를 해야 해요. <br />
        <br /> 또한 핸드폰 찾기 콜센터(https://www.handphone.co.kr/lostinfo.php)에서 핸드폰 습득물을
        조회할 수 있어요.
      </>
    ),
  ...
  },
  {
    ...
    content: (
      <>
        가까운 경찰서에 방문하여 분실 신고를 한 뒤, 분실 해당 장소 관리 주체에 직접 CCTV 열람 요청을
        해야 해요. <br />
        <br />
        공공 장소의 CCTV 열람이 필요한 경우 정보 공개 포털(https://www.open.go.kr)을 통해 정보 공개
        청구를 하여 CCTV 열람을 요청할 수 있어요.
      </>
    ),
