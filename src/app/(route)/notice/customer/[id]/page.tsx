    ...
    <div className="w-full">
      ...
      <div className="px-[20px]">
        <div className="mb-[18px] mt-[51px] px-[18px] py-[6px]">
          <p className="text-[14px] font-semibold text-green-500">문의내역</p>
        </div>

        <div className="space-y-[28px]">
          <div>
            <h1 className="text-[20px] font-semibold">{customerItem.title}</h1>
            <p className="text-[14px] leading-[20px] text-[#9D9D9D]">30분 전</p>
          </div>

          <p className="leading-[22px]">{customerItem.body}</p>
