...
import { MOCK_MYPAGE_REPORTS_ITEM } from "@/mock/MOCK_DATA";
import Link from "next/link";

const MypageReportsEmptyUI = () => {
  return (
...
const MypageReportsList = () => {
  return (
    <section>
      ...
      {MOCK_MYPAGE_REPORTS_ITEM.length === 0 && <MypageReportsEmptyUI />}
    </section>
  );
};

export default MypageReportsList;
