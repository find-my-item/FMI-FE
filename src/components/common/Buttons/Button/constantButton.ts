...
export const VARIANT_STYLES = {
  ...
  auth: {
    base: "w-full flex-center gap-1 rounded-[10px] bg-fill-brand-strong-default text-brand-subtle-default disabled:bg-fill-brand-strong-disabled disabled:text-brand-subtle-disabled",
  },
} as const;
