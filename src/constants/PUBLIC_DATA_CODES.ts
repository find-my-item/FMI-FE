/**
 * @author jikwon
 * @description 공공데이터 포털 경찰청 습득물 조회 API 관련 코드 상수
 */

/** 물품 대분류 코드 (PRDT_CL_CD_01) */
export const PUBLIC_CATEGORY_CODES = [
  { value: "PRH000", label: "가방" },
  { value: "PRI000", label: "귀금속" },
  { value: "PRJ000", label: "도서용품" },
  { value: "PRK000", label: "서류" },
  { value: "PRL000", label: "산업용품" },
  { value: "PRM000", label: "쇼핑백" },
  { value: "PRN000", label: "스포츠용품" },
  { value: "PRO000", label: "악기" },
  { value: "PRP000", label: "유가증권" },
  { value: "PRQ000", label: "의류" },
  { value: "PRR000", label: "자동차" },
  { value: "PRS000", label: "전자기기" },
  { value: "PRW000", label: "지갑" },
  { value: "PRT000", label: "증명서" },
  { value: "PRU000", label: "컴퓨터" },
  { value: "PRV000", label: "카드" },
  { value: "PRX000", label: "현금" },
  { value: "PRY000", label: "휴대폰" },
